...
ggsave("plots/teleco_churn.png", width = 9, height = 5)
...
ggplot(dados, aes(periodo, mshare, fill = operadora)) +
    ...
    theme_light() +
    labs(x = NULL, y = NULL, title = 'Market share, por operadora de celular, no Brasil',
         fill = NULL)

ggsave("plots/teleco_mshare.png", width = 9, height = 5)
